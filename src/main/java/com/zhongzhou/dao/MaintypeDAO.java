...
public interface MaintypeDAO {
     ...
     * @return 返回数据的数量
     */
    long countByExample(MaintypeCriteria example);
     ...
     * @return 返回更新成功的数量
     */
    int updateByExampleSelective(@Param("record") Maintype record, @Param("example") MaintypeCriteria example);
     ...
     * @return 返回更新成功的数量
     */
    int updateByExample(@Param("record") Maintype record, @Param("example") MaintypeCriteria example);
